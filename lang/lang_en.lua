...
langdata["en"] =
{
  ...
  menu_yes = "Yes",
  menu_no = "No",
  menu_no_desc = "No description available.",
  ...
  menu_quit_practice = "Quit Practice",
  ...
  menu_old_plate_place = "Old Grab Behavior",
  ...
  menu_desc_continue = "Unpause the game.",
  menu_desc_restart = "Restart the level.",
  menu_desc_quit = "Exit the level.",
  menu_desc_level_select = "Pick a level to start.",
  ...
  menu_desc_old_plate_place_off = "When grabbing an ingredient from a counter with a container, you will keep holding the container.",
  menu_desc_old_plate_place_on = "When grabbing an ingredient from a counter with a container, the container will be placed on the counter.",
  ...
  menu_desc_auto_start_on = "The game will automatically move to the next level.",
