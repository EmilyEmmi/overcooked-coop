...
OC_LEVEL_DATA = {
    ...
    [OC_LEVEL_WF] = {
        ...
        advice = "Bring dirty dishes to the sink and hold [ACTION] to wash them.",
        level = LEVEL_WF,
        totalTime = 210,
    ...
    [OC_LEVEL_SAND] = {
        ...
        advice = "To make burgers, cut a slab of meat and cook the patty, then place on a bun and add toppings.",
        level = LEVEL_SSL,
        totalTime = 210,
    ...
    [OC_LEVEL_CCM] = {
        ...
        advice = "Make pizza by combining cut dough, tomato, cheese, and other toppings, then baking the pizza in an oven.",
        level = LEVEL_CCM,
        totalTime = 210,
    ...
    [OC_LEVEL_BBH] = {
        ...
        advice = "You can't add toppings to pizzas once they're fully cooked.",
        level = LEVEL_BBH,
        totalTime = 240,
        failTime = {240, 210, 180, 160},
