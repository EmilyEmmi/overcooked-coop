...
OC_LEVEL_DATA = {
    [OC_LEVEL_TEST] = {
        name = "Test Level",
        desc = "Debug level containing all mechanics. Extremely challenging!",
        level = LEVEL_TEST,
        totalTime = 240,
    ...
    [OC_LEVEL_BOB] = {
        ...
        advice = "Press [GRAB] to grab ingredients, and hold [ACTION] on a cutting board to cut them.",
        tutorial = "Make salad by chopping lettuce, and optionally adding chopped tomatoes.",
        tutorialPic = get_texture_info("tip_1"),
        level = LEVEL_BOB,
        totalTime = 180,
    ...
    [OC_LEVEL_WF] = {
        ...
        tutorial = "Bring dirty dishes to the sink and hold [ACTION] to wash them.",
        tutorialPic = get_texture_info("tip_2"),
        level = LEVEL_WF,
        totalTime = 210,
    ...
    [OC_LEVEL_SHIP] = {
        ...
        advice = "You can't pass through red barriers, but ingredients can.",
        tutorial = "Make soup by cutting and cooking three ingredients of the same type in a pot.",
        tutorialPic = get_texture_info("tip_3"),
        level = LEVEL_JRB,
        totalTime = 240,
    ...
    [OC_LEVEL_LAVA] = {
        ...
        advice = "Ingredients will be destroyed if they fall into lava.",
        level = LEVEL_LLL,
        totalTime = 240,
    ...
    [OC_LEVEL_SAND] = {
        ...
        tutorial = "To make burgers, cut a slab of meat and cook the patty, then place on a bun and add toppings.",
        tutorialPic = get_texture_info("tip_4"),
        level = LEVEL_SSL,
        totalTime = 210,
    ...
    [OC_LEVEL_TTC] = {
        ...
        tutorial = "Press [THROW] to throw raw ingredients. Ingredients will bounce off of walls when thrown.",
        tutorialPic = get_texture_info("tip_5"),
        level = LEVEL_TTC,
        totalTime = 210,
        failTime = {210, 210, 180, 160},
    ...
    [OC_LEVEL_CCM] = {
        ...
        tutorial = "Make pizza by combining cut dough, tomato, cheese, and other toppings, then baking the pizza in an oven.",
        tutorialPic = get_texture_info("tip_6"),
        level = LEVEL_CCM,
        totalTime = 210,
    ...
    [OC_LEVEL_BBH] = {
        ...
        advice = "You can't add toppings to pizzas once they're fully baked.",
        level = LEVEL_BBH,
        totalTime = 240,
        failTime = {240, 210, 180, 160},
