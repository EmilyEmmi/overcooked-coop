...
const LevelScript level_ssl_entry[] = {
	...
	AREA(1, ssl_area_1),
		...
		OBJECT(E_MODEL_NONE, 1179, 332, 104, 0, -180, 0, (2), bhvIngredient),
		OBJECT(E_MODEL_NONE, 1179, 332, 208, 0, -180, 0, (2), bhvIngredient),
		OBJECT(E_MODEL_NONE, 1179, 332, 312, 0, -180, 0, (2), bhvIngredient),
		OBJECT(MODEL_NONE, -2000, 560, 0, 0, 180, 0, 0x000A0000, bhvAirborneWarp),
