...
const LevelScript level_ssl_entry[] = {
	...
	AREA(1, ssl_area_1),
		...
		OBJECT(E_MODEL_COUNTER_SIDE, -868, 280, 416, 0, -180, 0, 0x00000000, bhvCounter),
		...
		OBJECT(E_MODEL_COUNTER_SIDE, -660, 280, 416, 0, -180, 0, 0x00000000, bhvCounter),
		...
		OBJECT(E_MODEL_INGREDIENT_BOX, -764, 280, 416, 0, -180, 0, (3 << 16) | (11), bhvCounter),
		...
		OBJECT(E_MODEL_INGREDIENT_BOX, -556, 280, 416, 0, -180, 0, (3 << 16) | (12), bhvCounter),
		OBJECT(E_MODEL_PLATE_COUNTER, 1179, 280, 0, 0, -90, 0, (6 << 16), bhvCounter),
		OBJECT(E_MODEL_SERVING, -1180, 280, 260, 0, 90, 0, (5 << 16), bhvCounter),
		OBJECT(E_MODEL_SINK, -1180, 280, -260, 0, 90, 0, (7 << 16), bhvCounter),
		OBJECT(E_MODEL_TRASH, -972, 280, 416, 0, -180, 0, (2 << 16), bhvCounter),
		...
		OBJECT(E_MODEL_NONE, -1180, 332, -104, 0, -180, 0, (2), bhvIngredient),
		OBJECT(E_MODEL_NONE, -1180, 332, 0, 0, -180, 0, (2), bhvIngredient),
		OBJECT(E_MODEL_NONE, -1180, 332, 104, 0, -180, 0, (2), bhvIngredient),
		OBJECT(MODEL_NONE, -2000, 560, 0, 0, 180, 0, 0x000A0000, bhvAirborneWarp),
		OBJECT(E_MODEL_BITFS_SINKING_CAGE_PLATFORM, 0, 75, 2, 0, 0, 0, 0x00000000, bhvFallingRisingPlatform),
