...
const LevelScript level_ocTest_entry[] = {
	...
	AREA(1, ocTest_area_1),
		...
		OBJECT(E_MODEL_COUNTER_SIDE, 521, -1, -417, 0, 0, 0, 0x00000000, bhvCounter),
		...
		OBJECT(E_MODEL_SINK, 365, -1, -417, 0, 0, 0, (7 << 16), bhvCounter),
		OBJECT(E_MODEL_INGREDIENT_BOX, 729, -1, 103, 0, -90, 0, (3 << 16) | (4), bhvCounter),
		OBJECT(E_MODEL_TRASH, 625, -1, -417, 0, 0, 0, (2 << 16), bhvCounter),
		OBJECT(MODEL_NONE, 0, 560, 0, 0, 180, 0, 0x000A0000, bhvAirborneWarp),
		OBJECT(E_MODEL_NONE, 450, 1, -200, 0, 0, 0, (0), bhvOcSpawn),
		OBJECT(E_MODEL_NONE, 450, 1, 200, 0, 0, 0, (1), bhvOcSpawn),
		OBJECT(E_MODEL_NONE, -450, 1, 200, 0, 0, 0, (2), bhvOcSpawn),
		OBJECT(E_MODEL_NONE, -450, 1, -200, 0, 0, 0, (3), bhvOcSpawn),
