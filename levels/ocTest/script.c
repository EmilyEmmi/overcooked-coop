...
const LevelScript level_ocTest_entry[] = {
	...
	AREA(1, ocTest_area_1),
		...
		OBJECT(E_MODEL_COUNTER_CORNER, -727, -1, 415, 0, 90, 0, 0x00000000, bhvCounter),
		OBJECT(E_MODEL_COUNTER_SIDE, -415, -1, 415, 0, -180, 0, 0x00000000, bhvCounter),
		OBJECT(E_MODEL_COUNTER_SIDE, 417, -1, 415, 0, -180, 0, 0x00000000, bhvCounter),
		OBJECT(E_MODEL_COUNTER_SIDE, -623, -1, 415, 0, -180, 0, 0x00000000, bhvCounter),
		OBJECT(E_MODEL_COUNTER_SIDE, 625, -1, 415, 0, -180, 0, 0x00000000, bhvCounter),
		OBJECT(E_MODEL_COUNTER_CORNER, 729, -1, 415, 0, -180, 0, 0x00000000, bhvCounter),
		...
		OBJECT(E_MODEL_COUNTER_SIDE, 105, -1, 415, 0, -180, 0, 0x00000000, bhvCounter),
		OBJECT(E_MODEL_COUNTER_SIDE, 1, -1, 415, 0, -180, 0, 0x00000000, bhvCounter),
		OBJECT(E_MODEL_COUNTER_SIDE, -103, -1, 415, 0, -180, 0, 0x00000000, bhvCounter),
		OBJECT(E_MODEL_COUNTER_SIDE, -207, -1, 415, 0, -180, 0, 0x00000000, bhvCounter),
		OBJECT(E_MODEL_COUNTER_SIDE, 209, -1, 415, 0, -180, 0, 0x00000000, bhvCounter),
