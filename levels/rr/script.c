...
const LevelScript level_rr_entry[] = {
	...
	AREA(1, rr_area_1),
		...
		OBJECT(E_MODEL_COUNTER_CENTER, 883, -1, -571, 0, 0, 0, (4 << 24) | (0 << 16), bhvCounter),
		...
		OBJECT(E_MODEL_TRASH, 51, -1, -571, 0, 0, 0, (4 << 24) | (2 << 16), bhvCounter),
		OBJECT(MODEL_NONE, 1, 582, -1, 0, 180, 0, 0x000A0000, bhvAirborneWarp),
		MARIO_POS(0x01, 180, 1, 582, -1),
		OBJECT(E_MODEL_NONE, 261, 51, -573, 0, 0, 0, (15), bhvIngredient),
		OBJECT(E_MODEL_NONE, 469, 51, -573, 0, 0, 0, (15), bhvIngredient),
		OBJECT(E_MODEL_NONE, 157, 51, -573, 0, 0, 0, (2), bhvIngredient),
		OBJECT(E_MODEL_NONE, 365, 51, -573, 0, 0, 0, (2), bhvIngredient),
		OBJECT(E_MODEL_NONE, 573, 51, -573, 0, 0, 0, (2), bhvIngredient),
		OBJECT(MODEL_NONE, 0, 560, 0, 0, 180, 0, 0x000A0000, bhvAirborneWarp),
		OBJECT(E_MODEL_CUSTOM_CARPET, -468, 0, 312, 0, 0, 0, (1 << 8), bhvOcCarpet),
		OBJECT(E_MODEL_CUSTOM_CARPET, 468, 0, 312, 0, 0, 0, (2 << 8), bhvOcCarpet),
		OBJECT(E_MODEL_CUSTOM_CARPET, -468, 0, -312, 0, 0, 0, (3 << 8), bhvOcCarpet),
		OBJECT(E_MODEL_CUSTOM_CARPET, 468, 0, -312, 0, 0, 0, (4 << 8), bhvOcCarpet),
		OBJECT(E_MODEL_NONE, -468, 0, 312, 0, 0, 0, (1 << 24) | (0 << 16), bhvOcSpawn),
		OBJECT(E_MODEL_NONE, 468, 0, -312, 0, 0, 0, (3 << 24) | (1 << 16), bhvOcSpawn),
		OBJECT(E_MODEL_NONE, -468, 0, -312, 0, 0, 0, (3 << 24) | (2 << 16), bhvOcSpawn),
		OBJECT(E_MODEL_NONE, 468, 0, -312, 0, 0, 0, (4 << 24) | (3 << 16), bhvOcSpawn),
