...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(E_MODEL_COUNTER_SIDE, -156, 50, 1661, 0, -180, 0, 0x00000000, bhvCounter),
		OBJECT(E_MODEL_COUNTER_SIDE, -260, 50, 1661, 0, -180, 0, 0x00000000, bhvCounter),
		OBJECT(E_MODEL_COUNTER_CENTER, -780, 0, -208, 0, -90, 0, (1 << 24), bhvCounter),
		OBJECT(E_MODEL_COUNTER_CENTER, -780, 0, -104, 0, -90, 0, (1 << 24), bhvCounter),
		OBJECT(E_MODEL_COUNTER_CENTER, -780, 0, 0, 0, -90, 0, (1 << 24), bhvCounter),
		OBJECT(E_MODEL_COUNTER_CENTER, -780, 0, 104, 0, -90, 0, (1 << 24), bhvCounter),
		OBJECT(E_MODEL_COUNTER_CENTER, -780, 0, 208, 0, -90, 0, (1 << 24), bhvCounter),
		OBJECT(E_MODEL_COUNTER_CENTER, 780, 0, -208, 0, 90, 0, (1 << 24), bhvCounter),
		OBJECT(E_MODEL_COUNTER_CENTER, 0, 0, 260, 0, -90, 0, (1 << 24), bhvCounter),
		...
		OBJECT(E_MODEL_BBH_MERRY_GO_ROUND, 0, 0, 0, 0, 90, 0, (1 << 8), bhvCustomMerryGoRound),
